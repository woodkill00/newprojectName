...
from .models import OrderItem, Address, Payment, Order, StripePayment
# from .models import Product, OrderItem, Address, Payment, Order, Category, StripePayment
from apps.productApp.models import Category, Product
...
class ProductListView(generic.ListView):
    template_name = 'storeApp/storeApp_product_list.html'
...
class ProductDetailView(generic.FormView):
    template_name = 'storeApp/storeApp_product_detail.html'
    ...
    def get_success_url(self):
        return reverse("storeApp:summary")
...
class CartView(generic.TemplateView):
    template_name = "storeApp/storeApp_cart.html"
...
class IncreaseQuantityView(generic.View):
    def get(self, request, *args, **kwargs):
        ...
        order_item.save()
        return redirect("storeApp:summary")
...
class CheckoutView(LoginRequiredMixin, generic.FormView):
    template_name = 'storeApp/storeApp_checkout.html'
    form_class = AddressForm

    def get_success_url(self):
        return reverse("storeApp:payment")
...
class PaymentView(LoginRequiredMixin, generic.TemplateView):
    template_name = 'storeApp/storeApp_payment.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        context['CALLBACK_URL'] = self.request.build_absolute_uri(
            reverse("storeApp:thank-you"))
        return context

class StripePaymentView(LoginRequiredMixin, generic.FormView):
    template_name = 'storeApp/storeApp_stripe_payment.html'
...
class ThankYouView(generic.TemplateView):
    template_name = 'storeApp/storeApp_thanks.html'


class OrderDetailView(LoginRequiredMixin, generic.DetailView):
    template_name = 'storeApp/storeApp_order.html'
